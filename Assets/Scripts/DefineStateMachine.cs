...
public class DefineStateMachine : MonoBehaviour
{
    ...
    // この DefineStateMachine クラスのなにかを処理している状態クラス
    private class ProcessState : ImtStateMachine<DefineStateMachine>.State
    {
